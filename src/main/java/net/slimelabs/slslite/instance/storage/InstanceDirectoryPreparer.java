...
public final class InstanceDirectoryPreparer {
    ...
    InstanceDirectoryPreparer(
        ...
        this.volumeApplicator = new VolumeApplicator(
                selectedStrategy,
                copyEngine,
                overlayLayers,
                btrfsSnapshots,
        ...
        this.storageLifecycle = new PreparedStorageLifecycle(
                overlayLayers,
                btrfsSnapshots,
                snapshotHooks
        );
        this.replacementTransaction = new PersistentInstanceTransaction(
                this.instancesRoot,
                storageLifecycle
        );
    }
