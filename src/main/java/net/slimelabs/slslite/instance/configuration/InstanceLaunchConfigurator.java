...
public final class InstanceLaunchConfigurator {
    ...
    public InstanceLaunchConfigurator(
        ...
        this.forwarding = java.util.Objects.requireNonNull(
                forwarding,
                "forwarding"
        );
        this.processSpecs = java.util.Objects.requireNonNull(
                processSpecs,
                "processSpecs"
        );
    }
    ...
    public ProcessSpec configure(
            ...
            ProcessSpecificationException {
        Map<String, String> configuredProperties = new LinkedHashMap<>(
