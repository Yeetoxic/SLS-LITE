...
public final class AdminClaimService {
  ...
  public synchronized ClaimResult claim(Player player, String submittedCode) throws IOException {
  ...
  public static final class InsecureOfflineModeException extends IllegalStateException {
    public InsecureOfflineModeException() {
      super(
          "Persistent in-game administrators are disabled while Velocity " + "is in offline mode");
    }
  }
}
