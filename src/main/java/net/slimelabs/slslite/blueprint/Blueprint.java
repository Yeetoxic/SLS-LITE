...
public record Blueprint(
  ...
  private static Map<String, Map<String, Object>> copyYamlConfigs(
    ...
    java.util.LinkedHashMap<String, Map<String, Object>> copied = new java.util.LinkedHashMap<>();
  ...
  private static Map<String, Map<String, String>> copyTextFileConfigs(
    ...
    java.util.LinkedHashMap<String, Map<String, String>> copied = new java.util.LinkedHashMap<>();
    configured.forEach(
        (target, replacements) ->
            copied.put(
                target,
  ...
  static Map<String, String> validateEnvironment(Map<String, String> configured) {
    ...
    for (Map.Entry<String, String> entry : configured.entrySet()) {
      ...
      if (name == null || !name.matches("[A-Za-z_][A-Za-z0-9_]{0,127}")) {
        throw new IllegalArgumentException("Invalid blueprint environment variable name: " + name);
      }
      String portableName = name.toUpperCase(java.util.Locale.ROOT);
      if (!portableNames.add(portableName)) {
        throw new IllegalArgumentException("Duplicate portable environment variable name: " + name);
      }
      if (isProtectedEnvironmentName(portableName)) {
        throw new IllegalArgumentException("Blueprint environment variable is protected: " + name);
      }
  ...
  private static Map<String, Object> immutableAnnotationMap(Map<String, Object> configured) {
    java.util.LinkedHashMap<String, Object> copied = new java.util.LinkedHashMap<>();
