...
public final class SLSLimboInstaller {
  ...
  public SLSLimboInstallation install(
    ...
    ConfinedFiles.atomicWrite(
        runtimeDirectory,
        "settings.yml",
        settings(port, forwardingType, forwardingSecret, advertisedProtocol, maxPlayers)
  ...
  private static String settings(
    ...
    return """
                ...
                """
        .formatted(port, maxPlayers, advertisedProtocol, forwardingType, forwardingSecret);
  }
