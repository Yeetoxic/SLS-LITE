...
public final class SLSLimboProtocolCatalog {
    ...
    private static final String VERSION_CLASS =
            "ua.nanit.limbo.protocol.registry.Version";
    ...
    public static Map<Integer, String> inspect(Path runtimeJar) throws IOException {
        try (URLClassLoader loader = new URLClassLoader(
            ...
            for (Object version : versionClass.getEnumConstants()) {
                ...
                protocols.put(
                        (int) protocolNumber.invoke(version),
                        (String) displayName.invoke(version)
                );
            }
            ...
            throw new IOException(
                    "Unable to inspect bundled SLS-Limbo protocol support",
                    exception
            );
        }
    }
