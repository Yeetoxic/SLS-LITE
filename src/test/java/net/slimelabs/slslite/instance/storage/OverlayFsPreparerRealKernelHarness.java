...
/**
 * Opt-in full prepare/reset/delete harness for disposable privileged Linux.
 */
public final class OverlayFsPreparerRealKernelHarness {

    private static final String INSTANCE_ID = "game.abc123";

    private OverlayFsPreparerRealKernelHarness() {
    }
    ...
    public static void main(String[] arguments) throws Exception {
        ...
        try {
            ...
            Files.writeString(
                    prepared.resolve("world/level.dat"),
                    "private-before-reset"
            );
            ...
            if (Files.exists(prepared)) {
                throw new IllegalStateException(
                        "Prepared instance remained after safe delete"
                );
            }
            requireContent(lower.resolve("level.dat"), "template");
            System.out.println("SLS-LITE OverlayFS prepare/reset/delete PASS");
        } finally {
