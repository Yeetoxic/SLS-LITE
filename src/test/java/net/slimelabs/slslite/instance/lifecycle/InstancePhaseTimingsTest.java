...
class InstancePhaseTimingsTest {
  ...
  void ignoresDuplicateCompletionAndClampsARegressingTicker() {
    ...
    assertEquals(0L, timings.elapsedNanos(InstancePhaseTimings.Phase.PROCESS_LAUNCH).orElseThrow());
  }
  ...
  void recordsFirstPlayerFromProvisioningCompletionOnce() {
    ...
    assertEquals(250_000_000L, timings.firstPlayerConnected().orElseThrow());
