...
class VelocityBackendRegistryTest {
    ...
    void synchronizesAndRemovesDynamicRegistration() {
        ...
        BackendProtocolSynchronizer protocols = synchronizer(
                synchronizedName,
    ...
    private static ProxyServer proxy(Map<String, ServerInfo> registered) {
        ...
        return (ProxyServer) Proxy.newProxyInstance(
                ...
                (proxy, method, arguments) -> switch (method.getName()) {
                    case "getServer" -> Optional.ofNullable(
                            servers.get((String) arguments[0])
                    );
                    case "registerServer" -> {
    ...
    private static RegisteredServer registeredServer(ServerInfo info) {
        return (RegisteredServer) Proxy.newProxyInstance(
                ...
                (proxy, method, arguments) -> "getServerInfo".equals(
                        method.getName()
